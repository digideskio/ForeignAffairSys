<html>
  ...
  <body style="margin:0;padding:0;font-size:20px">
    <?php 
    echo '<br>';
    echo CHtml::link('导出Word文档', array('/visit/taskApplyPrint','id'=>$model->visit_id));
    echo '<br>';echo '<br>';
    ?> 
   ...
   <div style="width:210mm;height:250mm;margin:auto">
    ...
    <table align='center'>
      <tr>
        <td style="width:10mm;height:55mm;border-top:0px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid; ">审<br>批<br>意<br>见</td>
     ...
     /* $old=10;
      ...
      $empty=$old-$have;
        ...
        foreach($model->visitors as $k=>$v){
            //echo "<br>".$v['person_id']."<br>".$v->person->name."<br>";
            echo "<tr><td>".$v->person->name."</td><tr>";
        }
